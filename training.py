...
import nltk #manipulación de lenguaje natural.
...
nltk.download('punkt')#que se usa para tokenizar el texto.
nltk.download('wordnet')
nltk.download('omw-1.4')

words = []
classes = []# almacena categorias o etiquetas unicas 
documents = []
ignore_letters = ['?', '!', '¿', '.', ',']# lista de caracteres para ignorar durante el procesamiento de las palabras 
...
words = [lemmatizer.lemmatize(word) for word in words if word not in ignore_letters] #Lematiza todas las palabras y elimina las que están en ignore_letters.
